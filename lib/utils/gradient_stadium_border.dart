...
class GradientStadiumBorder extends OutlinedBorder {
  /// Create a stadium border.
  ///
  /// The [side] argument must not be null.
  const GradientStadiumBorder({BorderSide side = BorderSide.none})
      : assert(side != null),
        super(side: side);
  ...
  @override
  ShapeBorder scale(double t) => GradientStadiumBorder(side: side.scale(t));

  @override
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    assert(t != null);
    if (a is GradientStadiumBorder)
      return GradientStadiumBorder(side: BorderSide.lerp(a.side, side, t));
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    ...
    if (b is GradientStadiumBorder)
      return GradientStadiumBorder(side: BorderSide.lerp(side, b.side, t));
  ...
  @override
  GradientStadiumBorder copyWith({BorderSide? side}) {
    return GradientStadiumBorder(side: side ?? this.side);
  }
